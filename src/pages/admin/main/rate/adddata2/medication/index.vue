            ...
            <div class="value value-check">
                <div class="nav-content">
                    <div class="data-item">
                        ...
                        <el-select v-model="drugIndex" placeholder="请选择" @change="drugChange">
                        <el-option
                    ...
                    <div class="data-item">
                        ...
                        <el-input v-model="drugMethod" placeholder="请先选择药品名称" class="data-input"></el-input>
                    </div>
                    <div class="data-item">
                        <div class="item-title">
                            用药日期
                        ...
                        <div class="dose-item">
                            ...
                            <div class="item-text">
                                <div class="input-item">
                                    ...
                                    <inputnumber :min="0" :max="30"  @getNumber="getNumberP1" :value="numberP1" unit="片"></inputnumber>
                                </div>
                                <div class="input-item">
                                    <inputnumber :min="0" :max="30"  @getNumber="getNumberP2" :value="numberP2" unit="片"></inputnumber>
                                    <!-- <el-input v-model="input" placeholder="未填写" class="data-input"></el-input>
                                    <div class="unit">片</div> -->
                                </div>
                                <div class="input-item">
                                    <inputnumber :min="0" :max="30"  @getNumber="getNumberP3" :value="numberP3" unit="片"></inputnumber>
                                    <!-- <el-input v-model="input" placeholder="未填写" class="data-input"></el-input>
                                    <div class="unit">片</div> -->
                                </div>
                            </div>
...
import { saveMedication, } from '@/api/rate/rate'
...
export default {
    ...
    methods: {
        ...
        saving(){
            ...
            //     return;
            // }
            saveMedication(params).then((res)=>{
                console.log('保存用药信息返回结果',res);
