            ...
            <div class="value value-check">
                <div class="nav-content">
                    ...
                    <div class="data-item">
                        ...
                        <inputnumber :min="10" :max="200"  @getNumber="getNumberH" :value="record.height" unit="cm"></inputnumber>
                        <slider :min="10" :max="200" :num="record.height" @updateVal="updateNumberH"></slider>
                    ...
                    <div class="data-item">
                        ...
                        <!-- <el-input v-model="input" placeholder="请填写血压数据" class="data-input"></el-input> -->
                        <inputnumber :min="10" :max="200"  @getNumber="getNumberW" :value="record.weight" unit="kg"></inputnumber>
                        <slider :min="10" :max="200" :num="record.weight" @updateVal="updateNumberW"></slider>
                        <!-- <span class="unit">mmHg</span> -->
                    </div>
                </div>
            </div>
